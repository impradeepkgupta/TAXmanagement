        ...
        <div class="row align-self-stretch">
            ...
            <div class="col-sm-6 bg-light">
                ...
                <form action="employee validate.php" method="post">
                    <label for="fname">User ID<a class="text-danger"><sup>*</sup></a></label>
                    <input type="text" id="id" name="id" placeholder="User ID" class="form-control" >
                    <label for="fname">Password<a class="text-danger"><sup>*</sup></a></label>
                ...
                <div class="justify-content-center">    
                    <a>New User? </a><a href="employee register.php" align="center">Register Now</a>
                </div>
            </div>
            <div class="col-sm-3 bg-light"></div>
        </div>
